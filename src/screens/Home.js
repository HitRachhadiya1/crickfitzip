...
const a = ({ navigation }) => {
    ...
    return (
        <View>
          <StatusBar backgroundColor='#b6c463' barStyle='dark-content' />
      <View style={{ height: metrics.HEIGHT * 0.05, backgroundColor: '#b6c463' }}>
        <Text style={{ color: '#fff', fontSize: 22, fontWeight: '700', textAlign: 'center', marginVertical: 5 }}>Home</Text>
      </View>
